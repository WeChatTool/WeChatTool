...
For a first test, have another account send a new text message, then recall it. Check that the original message remains visible, including after reopening the conversation. Also verify normal messaging and access to your existing history before relying on the plugin.
