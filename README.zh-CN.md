...
首次测试时，请让另一个账号发送一条新的文字消息，然后撤回。重新打开会话，检查消息是否仍然可见。在正式使用插件前，也请确认正常收发消息和查看已有聊天记录等功能。
...
更新安装器时，请在 [Releases](https://github.com/WeChatTool/WeChatTool/releases) 有新版本可用后，下载适合这台 Mac 的打包版本。
