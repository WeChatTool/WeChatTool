...
The [v0.1.3 release](https://github.com/WeChatTool/WeChatTool/releases/tag/v0.1.3)
provides a [Universal installer ZIP](https://github.com/WeChatTool/WeChatTool/releases/download/v0.1.3/WeChatTool-Installer-0.1.3-universal2.zip)
...
```sh
xcrun notarytool submit "dist/arm64/WeChatTool-Installer-0.1.3-arm64.zip" \
...
ditto -c -k --sequesterRsrc --keepParent "dist/arm64/WeChatTool-Installer.app" \
  "dist/arm64/WeChatTool-Installer-0.1.3-arm64-notarized.zip"
shasum -a 256 "dist/arm64/WeChatTool-Installer-0.1.3-arm64-notarized.zip" \
  > "dist/arm64/WeChatTool-Installer-0.1.3-arm64-notarized.zip.sha256"
```
